...
public class HarpyAnimations {
	public static final AnimationDefinition HARPY_IDLEFLY = AnimationDefinition.Builder.withLength(1.25F).looping()
	...
	public static final AnimationDefinition HARPY_IDLEFIGHT = AnimationDefinition.Builder.withLength(1.25F).looping()
			.addAnimation("Torso", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(7.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			.addAnimation("Waist", new AnimationChannel(AnimationChannel.Targets.POSITION,
					new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.2158F, 0.2158F), AnimationChannel.Interpolations.LINEAR)
			))
			.addAnimation("LeftLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			.addAnimation("LowerrightLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					...
					new Keyframe(0.5417F, KeyframeAnimations.degreeVec(72.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition HARPY_WINGS1 = AnimationDefinition.Builder.withLength(1.25F).looping()
	...
	public static final AnimationDefinition HARPY_WINGS2 = AnimationDefinition.Builder.withLength(1.25F).looping()
			.addAnimation("LeftArm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
	...
	public static final AnimationDefinition HARPY_WINGS3 = AnimationDefinition.Builder.withLength(0.0F).looping()

			.build();

	public static final AnimationDefinition HARPY_SIT = AnimationDefinition.Builder.withLength(3.0F).looping()
			...
			.addAnimation("boobies", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
					new Keyframe(1.4583F, KeyframeAnimations.degreeVec(-2.5375F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition HARPY_MELEE = AnimationDefinition.Builder.withLength(0.8333F)
			.addAnimation("Torso", new AnimationChannel(AnimationChannel.Targets.ROTATION,
	...
	public static final AnimationDefinition HARPY_RANGED = AnimationDefinition.Builder.withLength(1.0F)
			.addAnimation("Torso", new AnimationChannel(AnimationChannel.Targets.ROTATION,
					new Keyframe(0.0F, KeyframeAnimations.degreeVec(7.5F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
