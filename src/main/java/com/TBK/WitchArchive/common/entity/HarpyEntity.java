...
public class HarpyEntity extends TamableAnimal {
    ...
    public HarpyEntity(EntityType<? extends TamableAnimal> p_21803_, Level p_21804_) {
        ...
        this.moveControl = new HarpyEntityMoveControl(this);
        this.xpReward = 3;
    }
    ...
    class HarpyEntityChargeAttackGoal extends Goal {
        ...
        public boolean canUse() {
            ...
            if (livingentity != null && livingentity.isAlive() && !HarpyEntity.this.getMoveControl().hasWanted() && HarpyEntity.this.random.nextInt(reducedTickDelay(7)) == 0) {
